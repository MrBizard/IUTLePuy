...
CComposante::CComposante(const LibGraph2::CString& strName, const LibGraph2::CRectangle& rect)
  : m_strName(strName)
  , m_rect(rect)
{
}

void CComposante::Associer(std::shared_ptr<CEnsCherch> pEnsCherch)
{
  Dissocier(pEnsCherch);
  m_pEnsCherchs.push_back(pEnsCherch);
}

void CComposante::Dissocier(std::shared_ptr<CEnsCherch> pEnsCherch)
{
...
bool CComposante::IsInside(const LibGraph2::CPoint& pos) const
{
